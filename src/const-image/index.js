...
const counterItems = [
  ...
  { value: 200, suffix: "+", label: "Code Contributions" },
  { value: 8, suffix: "+", label: "Completed Projects" },
  { value: 90, suffix: "%", label: "Task Completion Rate" },
];
...
const expCards = [
  {
    ...
    responsibilities: [
      "Led the development of web applications using React for frontend and Express.js for backend.",
      "Collaborated with backend engineers to integrate RESTful APIs with the React frontend.",
      "Worked on performance optimization techniques and server-side rendering with Next.js.",
    ],
  },
  {
    review:
    ...
    responsibilities: [
      "Developed and maintained mobile applications using Flutter for Android ",
      "Collaborated with UI/UX designers to create intuitive and responsive mobile designs.",
      "Optimized Flutter apps for speed and smooth user experiences using various performance techniques.",
    ],
  },
  {
    review:
    ...
    responsibilities: [
      ...
      "Integrated RESTful APIs and managed global state using Express.js",
      "Collaborated with UI/UX designers to translate designs into functional components.",
    ],
  },
];
