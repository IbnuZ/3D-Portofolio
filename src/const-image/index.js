...
const expCards = [
  {
    ...
    responsibilities: [
      "Led the development of web applications using React for frontend and Node.js for backend.",
  ...
  },
  {
    ...
    responsibilities: [
      "Developed and maintained mobile applications using Flutter for both Android and iOS.",
